      ...
      <main className="w-full max-w-xl px-6 mt-20 md:mt-28">
        ...
        >
          <form className="max-w-lg mx-auto" onSubmit={handleSubmit}>
            ...
            <label className="block text-sm font-semibold text-black mt-8 mb-3">
              Password
            </label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-8 w-full h-12 md:h-14 rounded-full text-white font-semibold text-lg transition-all"
              style={{
                background: ACCENT,
